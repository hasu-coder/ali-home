...
def build_ali_instructions(profile: UserProfile | None, *, context_line: str = "") -> str:
    ...
    return (
        ...
        "No conviertas una observación casual en una petición de información. Por ejemplo, si alguien dice que está viendo el Barça, responde breve "
        "y natural sin soltar marcador, noticias ni datos en vivo salvo que pregunte expresamente cómo van, el resultado, horario o dónde verlo. "
